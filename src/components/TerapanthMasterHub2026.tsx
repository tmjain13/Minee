...
const MASTER_VIHAR_LOGS = [
  // --- DELHI ---
  { name: "बहुश्रुत मुनिश्री उदित कुमार जी", tag: "ठाणा-3", loc: "तेरापंथ भवन, ए-875, शास्त्री नगर, दिल्ली।", contact: "9983478999", state: "DELHI" },
  ...
  { name: "शासनश्री साध्वीश्री संघमित्राजी", tag: "ठाणा-5", loc: "एक्शन बालाजी अस्पताल, पश्चिम विहार, दिल्ली।", contact: "9950120242", state: "DELHI" },
  { name: "शासनश्री साध्वीश्री सुव्रताजी", tag: "ठाणा-4", loc: "अणुव्रत भवन, 210, दीनदयाल उपाध्याय मार्ग, नई दिल्ली।", contact: "8375941210", state: "DELHI" },
  { name: "शासनश्री साध्वीश्री सुमनश्री जी", tag: "ठाणा-4", loc: "तेरापंथ भवन, सेक्टर-05, रोहिणी, दिल्ली।", contact: "9915501240", state: "DELHI" },
  { name: "शासनश्री साध्वीश्री रविप्रभाजी", tag: "ठाणा-5", loc: "ओसवाल भवन, बी-69, विवेक विहार-2, दिल्ली।", contact: "8104273773", state: "DELHI" },

  // --- RAJASTHAN ---
  { name: "मुनिश्री मुनिव्रत जी", tag: "ठाणा-3", loc: "महाप्रज्ञ भवन, सिरियारी, राजस्थान।", contact: "ℹ️ ऑन-साइट", state: "RAJASTHAN" },
  { name: "मुनिश्री तत्व रुचि जी 'तरुण'", tag: "ठाणा-2", loc: "भिक्षु साधना केंद्र, श्याम नगर, जयपुर।", contact: "9660692852", state: "RAJASTHAN" },
  { name: "मुनिश्री सुधाकर जी", tag: "ठाणा-2", loc: "नरेंद्र जी धीरज जी अरविंद बैद निवास, 179, मल्होत्रा नगर, विद्याधर नगर स्टेडियम के पास, जयपुर।", contact: "8870651529", state: "RAJASTHAN" },
  { name: "मुनिश्री अमृत कुमार जी", tag: "ठाणा-4", loc: "बोथरा भवन, Ganga शहर, राजस्थान।", contact: "ℹ️ ऑन-साइट", state: "RAJASTHAN" },
  { name: "शासनश्री साध्वीश्री जसवती जी", tag: "ठाणा-3", loc: "तेरापंथ भवन, आसींद, राजस्थान।", contact: "9251316471", state: "RAJASTHAN" },
  { name: "शासनश्री साध्वीश्री धनश्री जी", tag: "ठाणा-4", loc: "तेरापंथ भवन, गुलाब बाड़ी, कोटा।", contact: "9649509233", state: "RAJASTHAN" },
  { name: "शासनश्री मंजु प्रभा जी", tag: "ठाणा-3", loc: "दुग्गड़ भवन, बीकानेर, राजस्थान।", contact: "ℹ️ ऑन-साइट", state: "RAJASTHAN" },

  // --- GUJARAT ---
  { name: "डॉ मुनिश्री मदन कुमारजी स्वामी", tag: "ठाणा-3", loc: "क्रिश हाइट्स, संजीव कुमार ऑडिटोरियम के पास, RTO रोड, पाल अडाजण, सूरत।", contact: "6377377427", state: "GUJARAT" },
  { name: "मुनिश्री मुनिसुव्रत कुमार जी स्वामी", tag: "ठाणा-3", loc: "अर्हम कुंज, शाहीबाग, अहमदाबाद।", contact: "7021591184", state: "GUJARAT" },
  { name: "मुनिश्री संजयकुमार जी", tag: "ठाणा-4", loc: "राहुल हाउस, प्रशांत सोसायटी, नवरंग पुरा, अहमदाबाद।", contact: "7597245913", state: "GUJARAT" },
  { name: "शासनश्री साध्वीश्री रामकुमारीजी", tag: "ठाणा-4", loc: "तेरापंथ भवन, कांकरिया, मणिनगर, अहमदाबाद।", contact: "9408472957", state: "GUJARAT" },
  { name: "साध्वीश्री मधुबाला जी (शासनश्री)", tag: "ठाणा-5", loc: "तेरापंथ भवन, सिटीलाइट, सूरत, गुजरात।", contact: "8128559659", state: "GUJARAT" },

  // --- KARNATAKA & OTHERS ---
  { name: "मुनिश्री विनीत कुमार जी", tag: "ठाणा-2", loc: "नंबर 264, 8वां क्रॉस, शास्त्रीनगर, त्यागराजनगर, बैंगलोर-70।", contact: "ℹ️ मार्ग में", state: "KARNATAKA" },
  { name: "मुनिश्री आकाश कुमार जी", tag: "ठाणा-2", loc: "नंबर 264, 8वां क्रॉस, शास्त्रीनगर, त्यागराजनगर, बेंगलुरु - 70।", contact: "8553336928", state: "KARNATAKA" },
  { name: "मुनिश्री दीप कुमार जी", tag: "ठाणा-2", loc: "महावीर सिग्नेचर अपार्टमेंट, मानसरोवर हाइट्स, हैदराबाद।", contact: "8505098254", state: "TELANGANA" },
  { name: "साध्वीश्री राजकुमारी जी", tag: "ठाणा-3", loc: "तुलसी सेवा केंद्र, मॉडल टाउन, हिसार, हरियाणा।", contact: "ℹ️ ऑन-साइट", state: "HARYANA" }
];
