...
const DEFAULT_NOTIFICATIONS: NotificationItem[] = [
  ...
  },
  {
    ...
    body: 'परम पूज्य मुनि उदित कुमार जी ठाणा २ का पीतमपुरा जैन भवन, दिल्ली में मंगल पर्दापण हुआ है। सांध्य प्रतिक्रमण आज ६:२८ पर शुरू होगा।',
    time: '4 hours ago',
    urgent: false,
    read: false
  },
  ...
  const triggerSelfTestNotification = () => {
    const alertsPool = [
      ...
      },
      {
        ...
        body: 'मुनि अमर कीर्ति जी ठाणा ३ का कल प्रातः ५:३० पर अनवरत विहार रोहिणी से पीरागढ़ी की तरफ निर्धारित हुआ है।',
        urgent: false
      },
      {
